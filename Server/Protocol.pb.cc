...
PROTOBUF_CONSTEXPR C_Dummy::C_Dummy(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.success_)*/false
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct C_DummyDefaultTypeInternal {
  PROTOBUF_CONSTEXPR C_DummyDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~C_DummyDefaultTypeInternal() {}
  union {
    C_Dummy _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 C_DummyDefaultTypeInternal _C_Dummy_default_instance_;
}  // namespace Protocol
...
const uint32_t TableStruct_Protocol_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::Protocol::C_Dummy, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::C_Dummy, _impl_.success_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 72, -1, -1, sizeof(::Protocol::C_Dummy)},
};
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::Protocol::_C_Dummy_default_instance_._instance,
};
...
const char descriptor_table_protodef_Protocol_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "StoneInfo\"\032\n\007C_Dummy\022\017\n\007success\030\001 \001(\010b\006p"
  "roto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_Protocol_2eproto = {
    false, false, 605, descriptor_table_protodef_Protocol_2eproto,
    "Protocol.proto",
...
class C_Dummy::_Internal {
 public:
};

C_Dummy::C_Dummy(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:Protocol.C_Dummy)
}
C_Dummy::C_Dummy(const C_Dummy& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  C_Dummy* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.success_){}
    , /*decltype(_impl_._cached_size_)*/{}};
  ...
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  _this->_impl_.success_ = from._impl_.success_;
  // @@protoc_insertion_point(copy_constructor:Protocol.C_Dummy)
}

inline void C_Dummy::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
C_Dummy::~C_Dummy() {
  // @@protoc_insertion_point(destructor:Protocol.C_Dummy)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void C_Dummy::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void C_Dummy::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void C_Dummy::Clear() {
// @@protoc_insertion_point(message_clear_start:Protocol.C_Dummy)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* C_Dummy::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
...
uint8_t* C_Dummy::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:Protocol.C_Dummy)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Protocol.C_Dummy)
  return target;
}

size_t C_Dummy::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Protocol.C_Dummy)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData C_Dummy::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    C_Dummy::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*C_Dummy::GetClassData() const { return &_class_data_; }


void C_Dummy::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<C_Dummy*>(&to_msg);
  auto& from = static_cast<const C_Dummy&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:Protocol.C_Dummy)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void C_Dummy::CopyFrom(const C_Dummy& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:Protocol.C_Dummy)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool C_Dummy::IsInitialized() const {
  return true;
}

void C_Dummy::InternalSwap(C_Dummy* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_impl_.success_, other->_impl_.success_);
}

::PROTOBUF_NAMESPACE_ID::Metadata C_Dummy::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Protocol_2eproto_getter, &descriptor_table_Protocol_2eproto_once,
...
template<> PROTOBUF_NOINLINE ::Protocol::C_Dummy*
Arena::CreateMaybeMessage< ::Protocol::C_Dummy >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Protocol::C_Dummy >(arena);
}
